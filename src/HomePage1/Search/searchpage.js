...
export default class Searchpage extends React.Component{
    ...
    <Row>
      ...
      <Col span={8}><div className={SearchPage.searchpage2}> <div className={SearchPage.searchpage2a}><Search placeholder="input SearchPage text" onSearch={value => console.log(value)} enterButton /></div></div></Col>
